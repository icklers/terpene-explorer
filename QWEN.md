...
- TypeScript 5.7.2, Node.js 24 LTS, ES2022 target + React 19.2.0, Material UI 6.3.0, Emotion 11.13.5, Vite 6.0.3, Vitest (testing), Playwright (E2E), i18next 25.6.0, react-i18next 15.2.0 (005-table-filter-bar)
- Static JSON files (`/data/terpene-database.json`, `/data/terpene-translations-de.json`) - client-side only (005-table-filter-bar)
...
## Recent Changes
- 005-table-filter-bar: Added TypeScript 5.7.2, Node.js 24 LTS, ES2022 target + React 19.2.0, Material UI 6.3.0, Emotion 11.13.5, Vite 6.0.3, Vitest (testing), Playwright (E2E), i18next 25.6.0, react-i18next 15.2.0
